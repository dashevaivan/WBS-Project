...
<h1 class="card-title d-flex justify-content-center" style="font-family: Montserrat; font-weight: bold; margin-top: 40px; margin-bottom: 40px;">Ubah Laporan Anda</h1>
...
<div class="container">
    ...
    <form action="{{ route('reports.update', $report->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="d-grid gap-2">
            <button type="submit" class="btn btn-primary" style="border-radius: 22px; background-color: #00BCF4; font-weight: bold; text-align: center;">Perbarui Laporan</button>
        </div>
    </form>
</div>
